...
def main() -> None:
    ...
    def rrf_retriever(question, index, provider, top_k):
        dense_results = retrieve(question, dense_index, provider, CANDIDATE_K)
        bm25_results = bm25_index.search(question, CANDIDATE_K)
        return reciprocal_rank_fusion(
            [dense_results, bm25_results], top_k=top_k, rrf_k=RRF_K
        )
    ...
    run_config = {
        ...
        "pipeline": pipeline,
        "retrievers": ["dense:text-embedding-3-large", "BM25:k1=1.5,b=0.75"],
